...
with open("vs.csv", "r") as fp:
    ...
    for line in reader:
        ...
        # else:
        #     data.append(d + [1, 1, 1, 1, 0])
        data.append(d + [1, 1, 1, 1, 1, 1, 0])  # my_g, my_g_lp, min, max, vs_lp
        last_val = d
...
HEADER = ["ts", "vs", "theta", "vs", "g(orig)", "g_lp(orig)", "my g", "my g_lp", "lp_min", "lp_max", "lp vs"]
table = data

print(tabulate(table, headers=HEADER, showindex=False), file=output)
print("-" * width, file=output)
